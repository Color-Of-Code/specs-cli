...
Any authoring actor — typically generated by **Analyst** or **Architect** during review, and consumed by **Reviewers** *(role)* and **Stakeholders** *(actor)* to confirm coverage. See [../actors.md](../actors.md) and [../roles.md](../roles.md).
